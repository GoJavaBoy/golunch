...
public class RestaurantTestData {
    public static final TestMatcher<Restaurant> MEAL_MATCHER = TestMatcher.usingIgnoringFieldsComparator(Restaurant.class);
    ...
    public static final Restaurant adminRestaurantHoniPoke = new Restaurant(ADMIN_RESTAURANT_HONI_POKE_ID + 2, "Honi Poke");
    ...
    public static Restaurant getUpdated() {
        ...
        updatedRestaurant.getMenu().add(new Dish("Updater Restaurant Dish #1", new BigDecimal("15.25")));
        updatedRestaurant.getMenu().add(new Dish("Updater Restaurant Dish #2", new BigDecimal("20.99")));
